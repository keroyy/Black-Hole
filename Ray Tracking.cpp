...
int main()
{
    ...
    Shader rayTrackingShader("rayTracking.vs", "rayTracking.frag");
...
#pragma endregion
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform1f(glGetUniformLocation(rayTrackingShader.Program, "time"), (GLfloat)glfwGetTime() * 0.1f);
        glUniform1f(glGetUniformLocation(rayTrackingShader.Program, "aspect"), (GLfloat)screenWidth / (GLfloat)screenHeight);
